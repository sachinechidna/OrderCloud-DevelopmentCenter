...
function CoursesService($q, Underscore) {
	...
	var courses = [
		...
		},
		{
			...
			Difficulty: 'Beginner',
			Classes: ['buyer-crud', 'user-crud', 'group-crud', 'prod-crud', 'price-sched-crud', 'prod-assignments', 'category-crud', 'category-prod-assignment', 'category-assignment', 'get-products-as-user'],
